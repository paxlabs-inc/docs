...
<Card title="Deployed CTM" icon="link">
  **Address:** `0x477A9f214c947e6D81b9d32b6b1883F4a4ffFb24`
  ...
  [View on PaxScan →](https://paxscan.io/address/0x477A9f214c947e6D81b9d32b6b1883F4a4ffFb24)
</Card>
...
<CardGroup cols={2}>
  <Card
    ...
    icon="github"
    href="https://github.com/Paxeer-Network/Pax-v3-coreCTM"
  >
  ...
  <Card
    ...
    href="https://paxscan.io/address/0x477A9f214c947e6D81b9d32b6b1883F4a4ffFb24"
  >
    Explore on PaxScan
  </Card>
  <Card
