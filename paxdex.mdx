...
<CardGroup cols={2}>
  <Card title="Vault Contract" icon="vault">
    ...
    ```
    [View on Explorer →](https://paxscan.paxeer.app/address/0x49B0f9a0554da1A7243A9C8ac5B45245A66D90ff)
  </Card>
  ...
  <Card title="Oracle Contract" icon="crystal-ball">
    ...
    ```
    [View on Explorer →](https://paxscan.paxeer.app/address/0x6e5da6d7a89c6B7cB0e5c64fcf326292F76A0352)
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    href="https://paxscan.paxeer.app/address/0x49B0f9a0554da1A7243A9C8ac5B45245A66D90ff"
  >
    View on PaxeerScan
  </Card>
  <Card
    ...
    icon="magnifying-glass"
    href="https://paxscan.paxeer.app/address/0x6e5da6d7a89c6B7cB0e5c64fcf326292F76A0352"
  >
    View on PaxeerScan
  </Card>
  <Card
