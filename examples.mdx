---
title: "Code Examples"
description: "Integration guides and code samples for building on HyperPaxeer"
icon: "brackets-curly"
---
...
<Tabs>
  ...
  <Tab title="Web3Modal">
    ...
    const metadata = {
      ...
      url: 'https://myapp.com',
      icons: ['https://myapp.com/icon.svg']
    }
        ...
        <div className="space-y-4">
          ...
          {isSuccess && (
            <div className="text-green-600">
              Transfer successful! 
              <a href={`https://paxscan.io/tx/${hash}`} target="_blank">
                View transaction
              </a>
            </div>
          )}
