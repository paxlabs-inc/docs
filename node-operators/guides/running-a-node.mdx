...
description: "Learn how to run a HyperPaxeer node"
icon: "server"
---

## Overview

Running a HyperPaxeer node allows you to interact with the network independently, verify transactions, and contribute to network decentralization.
...
```bash
--paxeer                    # Run as HyperPaxeer node
