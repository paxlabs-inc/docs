...
Paxeer Network nodes can enable [Cosmos SDK telemetry](https://docs.cosmos.network/main/learn/advanced/telemetry)
to allow for observing and gathering insights about the Paxeer Network application.
...
Find below a list of supported Paxeer Network modules with custom metrics and telemetry.
