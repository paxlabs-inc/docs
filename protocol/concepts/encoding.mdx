...
previous versions, specially for client encoding and signing with Ledger devices. Paxeer Network does not
...
allows for quick reconstruction of encoded data. Paxeer Network uses RLP to encode/decode Ethereum
