...
However, as Paxeer Network also accepts EVM transactions, handling only those transactions that conform to EIP-155
...
By default, replay protection is enabled on any Paxeer Network node.
