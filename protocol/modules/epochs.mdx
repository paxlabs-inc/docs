...
This document specifies the internal `x/epochs` module of the Paxeer Network Hub.
...
Other Paxeer Network modules can then register logic to be executed at the timer ticks.
