...
You might encounter both terminologies on Paxeer Network since it builds Ethereum on top of the SDK,
...
Thus, the tip for an EIP-1559 transaction on Paxeer Network should be zero
