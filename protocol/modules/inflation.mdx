...
The `x/inflation` module mints new Paxeer Network tokens and allocates them in daily
...
### Paxeer Network Token Model

The Paxeer Network Token Model outlines how the Paxeer Network network is secured through a
...
issue 1 billion Paxeer Network tokens within the first 4 years.
...
a daily provision (`epochProvison`) of Paxeer Network tokens is minted
