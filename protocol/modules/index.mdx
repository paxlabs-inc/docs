---
title: Modules
description: Cosmos SDK modules and how they compose the protocol.
---

# List of Modules

Here is a list of all production-grade modules that can be used on the Paxeer Network blockchain, along with their respective documentation:
...
- [erc20](erc20.md) - Trustless, on-chain bidirectional internal conversion of tokens
  between Paxeer Network' EVM and Cosmos runtimes.
...
Paxeer Network uses the following Cosmos SDK modules:
...
Paxeer Network uses the following the IBC modules for the SDK:
