...
A similar setup is used by the Paxeer Network team to get insights
about the impact of new features and testing different user flows.
This testing setup can be found on the [Paxeer Network testing repository](https://github.com/Paxeer-Network/testing).
