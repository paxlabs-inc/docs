...
The simplest way to start a local Paxeer Network node is by using the provided helper script on the base level of the [Paxeer Network repository](https://github.com/Paxeer-Network/Paxeer-Network/blob/main/local_node.sh),
...
:::tip
Paxeer Network currently only supports 24 word mnemonics.
:::
...
external_labels:
  monitor: 'Paxeer Network'

scrape_configs:
- job_name: 'Paxeer Network'
