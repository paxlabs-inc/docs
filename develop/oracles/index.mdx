---
title: Oracles
description: Connect smart contracts to off-chain data sources.
---

# Oracles

Paxeer Network supports several oracle providers to enable smart contracts to access
