...
- [Paxeer NetworkJS](https://github.com/Paxeer-Network/Paxeer-Networkjs) - is the official Paxeer Network client Typescript library. This library contains
 several packages:
    - [Address Converter](https://www.npmjs.com/package/@Paxeer Network/address-converter)
    - [EIP-712](https://www.npmjs.com/package/@Paxeer Network/eip712)
    - [Proto](https://www.npmjs.com/package/@Paxeer Network/proto)
    - [Provider](https://www.npmjs.com/package/@Paxeer Network/provider)
    - [Transactions](https://www.npmjs.com/package/@Paxeer Network/transactions)
- [PyPaxeer Network](https://github.com/sterliakov/pyPaxeer Network) - is a community-led Python library developed by [sterliakov](https://github.com/sterliakov)
