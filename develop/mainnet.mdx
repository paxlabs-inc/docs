...
:::note
An Paxeer Network validator, Stakely.io, runs a [faucet](https://stakely.io/en/faucet/Paxeer-Network-evm) for builders to request dust.
:::
...
Thoroughly test your smart contracts on the Paxeer Network Testnet to ensure it operates as intended. Comprehensive tests should
...
eligible receivers of an airdrop have a look at the [Paxeer Network Rektdrop](https://medium.com/Paxeer-Network/the-Paxeer Network-rektdrop-abbe931ba823).

### Token Registration

Paxeer Network allows for ERC-20 tokens to be used cross-chain. Once some of your tokens have been minted, you can register a token
pair through governance, which will allow users to send your tokens across chains. Head over to our Academy to learn how
to [register your ERC-20 token](https://academy.hyperpaxd.org/articles/advanced/erc20-registration).

## Community

Make yourself heard in the Paxeer Network community and explain what value your dApp provides.
...
Head over to the [Paxeer Network Discord](https://discord.gg/Paxeer-Network) channel get in touch with the community and contributors and
showcase your dApp on one of the next community calls. We also have a [Telegram group](https://t.me/Paxeer-NetworkBuilders) for
our builders.
