---
title: Develop
description: Build on HyperPaxeer Network.
---

# Getting Started

Looking to build a dApp on Paxeer Network? Following this documentation and our academy
you can learn how and become part of the rich ecosystem of EVM builders on
Cosmos. Whether you are building new use cases on Paxeer Network or porting an existing
...
## Why develop dApps on Paxeer Network?

The Paxeer Network Core Development Team is on a mission to provide the foundational tools necessary for building the cross-chain
applications of the future, freeing developers from the confines of today’s siloed blockchains.

Paxeer Network focuses on cross-chain **innovation** so that developers can build entirely new dApp experiences for their users.
Deploying smart contracts on Paxeer Network is **easy**, as the Paxeer Network blockchain is fully compatible with Ethereum and its rich
ecosystem of robust tooling, wallets, explorers, a surplus of assets, and intelligent end-users. At the same time,
Paxeer Network allows developers to build **scalable** EVM dApp chains with the upcoming Paxeer Network SDK and it hosts one of the
most active community governance that seeks **fairness** across all key actors (users, builders, and validators).

Paxeer Network does this by leveraging the interoperability of the Cosmos Ecosystem and the market-dominating support for EVM
...
You can also contribute to the Paxeer Network ecosystem without building a dApp. Head over to [tools](./tools/index.md) to learn
