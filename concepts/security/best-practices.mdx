...
description: "Essential security practices for building on HyperPaxeer"
icon: "shield-check"
---

## Overview

Security is paramount when building blockchain applications. This guide covers essential security practices for smart contract development on HyperPaxeer.
