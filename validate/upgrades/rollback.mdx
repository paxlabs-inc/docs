...
2. Then, copy the contents of your backup data directory back to the `HyperPaxeer_HOME/data` directory (which, by default,
...
3. Next, install the previous version of HyperPaxeer.

```bash
# from HyperPaxeer directory
