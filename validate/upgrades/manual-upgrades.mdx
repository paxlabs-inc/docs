...
## 1. Upgrade the HyperPaxeer version

Before upgrading the HyperPaxeer version. Stop your instance of `hyperpaxd` using `Ctrl/Cmd+C`.

Next, upgrade the software to the desired release version. Check the HyperPaxeer [releases page](https://github.com/Paxeer-Network/Paxeer-Network/releases)
...
Verify that you've successfully installed HyperPaxeer on your system by using the `version` command:
