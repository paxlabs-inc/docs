...
logic. This facilitates smoothly upgrading Paxeer Network to a new (breaking) software version as it automatically handles
...
([Semver](https://semver.org/)) of the corresponding software [release version](https://github.com/Paxeer-Network/Paxeer-Network/releases)
(*i.e* `vX.Y.Z`):
