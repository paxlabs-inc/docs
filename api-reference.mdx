---
title: "API Reference"
description: "Complete JSON-RPC API reference for HyperPaxeer"
icon: "book"
---

## Overview

Complete JSON-RPC API reference for HyperPaxeer. All standard Ethereum methods are supported.
...
<Note>
HyperPaxeer Chain ID is **125** (0xe5 in hex)
</Note>
